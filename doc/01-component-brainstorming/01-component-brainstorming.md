...
- Component Design #3: Music Playlist
  - **Description**:
    ...
    songs, and make other modifications to the playlist.
  - **Kernel Methods**:
    - addSong() --> Adds song to end of playist
    - removeSong() --> removes and returns song at the end of the playlist
    - playlistLenght() --> returns the length of the playlist
  - **Secondary Methods**:
